...
public static class ProtocolVersion
{
    ...
    /// <summary>Compatible additions (new optional fields or message types) bump the minor version. 0.3: internet connection codes and invitations. 0.4: Goodbye on internet links. 0.5: sync profiles.</summary>
